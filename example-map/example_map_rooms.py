...
from text_game_maker.game_objects.items import (Item, Food, Weapon, Bag,
    SmallBag, SmallTin, Coins, Blueprint, Paper, PaperBag, Furniture)
...
def prison_starting_cell(builder):
    ...
    tin.add_items([idcard, lockpick_blueprint, coins2])

    # Add all the items to the room
    builder.add_items([bunk, string, rucksack, tin, paperbag])
